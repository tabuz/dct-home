    ...
    <div class="mx-auto max-w-7xl px-6">
      ...
      <div class="mb-16 max-w-2xl">
        ...
        <h1 class="text-4xl font-bold tracking-tight text-white sm:text-6xl">
          Engineering Intelligence,<br class="hidden sm:block" />
          Shared Openly.
        </h1>
        <p class="mt-5 text-lg leading-relaxed text-zinc-400">
          Perspectives on headless ERP architecture, AI orchestration, and the
          future of construction technology — from the team building it.
        </p>
      </div>
      ...
      >
        ...
        <div class="flex flex-col justify-between p-10 lg:col-span-3 lg:p-14">
          <div>
            ...
            <h2
              class="text-2xl font-bold leading-snug tracking-tight text-white transition-colors group-hover:text-emerald-400 sm:text-3xl"
            >
              {{ featured.title }}
            </h2>
            <p
          ...
          <div
            class="mt-8 flex items-center gap-2 text-sm font-medium text-emerald-400"
          >
            Read article
            <UIcon
        ...
        <div
          class="hidden items-center justify-center border-l border-zinc-800 bg-zinc-950 p-10 lg:col-span-2 lg:flex"
        >
          <div class="w-full max-w-xs font-mono text-xs leading-6">
            ...
            <p class="mt-3 text-zinc-700">
              // {{ new Date(featured.date).toISOString().slice(0, 10) }}
            </p>
          </div>
        </div>
      </NuxtLink>
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <h2
            class="flex-1 text-lg font-semibold leading-snug text-white transition-colors group-hover:text-emerald-400"
          >
            {{ post.title }}
          </h2>
          <p
            v-if="post.description"
            class="mt-3 text-sm leading-relaxed text-zinc-400 line-clamp-3"
          >
            {{ post.description }}
          </p>
          <div
